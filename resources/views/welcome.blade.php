...
<head>
    ...
    <title>Dana Holdings - Construction & Real Estate Company</title>
    <meta name="author" content="Dana Holdings">
    <meta name="description" content="Dana Holdings - Construction & Real Estate Company">
    <meta name="keywords" content="Dana Holdings, Construction, Real Estate">
    ...
    @foreach(['57x57', '60x60', '72x72', '76x76', '114x114', '120x120', '144x144', '152x152', '180x180'] as $size)
        <link rel="apple-touch-icon" sizes="{{ $size }}"
              href="{{ asset('assets/img/favicons/apple-icon-'.$size.'.png') }}">
    @endforeach
        ...
        <div class="widget  ">
            <div class="th-widget-about">
                <div class="about-logo">
                    <a href="index.html"><img src="{{ asset('logo.png') }}" alt="Konta"></a>
                </div>
                ...
                <div class="recent-post">
                    ...
                    <div class="media-body">
                        <div class="recent-post-meta">
                            <a href="blog.html"><i class="fa-solid fa-calendar-days"></i>06 Aug, 2023</a>
                        </div>
                        <h4 class="post-title"><a class="text-inherit" href="blog-details.html">Regular inspections and
                                quality check</a></h4>
                    </div>
                </div>
                <div class="recent-post">
                    ...
                    <div class="media-body">
                        <div class="recent-post-meta">
                            <a href="blog.html"><i class="fa-solid fa-calendar-days"></i>22 June, 2023</a>
                        </div>
                        <h4 class="post-title"><a class="text-inherit" href="blog-details.html">Interior design is the
                                Art and Design</a></h4>
                    </div>
                </div>
                <div class="recent-post">
                    ...
                    <div class="media-body">
                        <div class="recent-post-meta">
                            <a href="blog.html"><i class="fa-solid fa-calendar-days"></i>05 July, 2023</a>
                        </div>
                        <h4 class="post-title"><a class="text-inherit" href="blog-details.html">Starting Construction Is
                                Not So Easy</a></h4>
                    </div>
                </div>
            </div>
...
<div class="th-menu-wrapper">
    <div class="th-menu-area text-center">
        ...
        <div class="mobile-logo">
            <a href="index.html"><img src="{{ asset('logo.png') }}" alt="Dana Holdings"></a>
        </div>
                    ...
                    <ul class="sub-menu">
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="home-9.html">Home Solar Energy <span class="new-label">New</span></a></li>
                                <li><a href="home-10.html">Home Infinite Construction <span class="new-label">New</span></a>
                                </li>
...
<header class="th-header header-layout1">
    <div class="header-top" data-bg-src="assets/img/bg/header-top1-bg.png">
        <div class="container th-container2">
            <div class="row justify-content-center justify-content-lg-between align-items-center gy-2">
                <div class="col-auto d-none d-lg-block">
                    <div class="header-links">
                        <ul>
                            <li>Welcome to Konta Construction And Repairing Service</li>
                            <li>
                                <div class="dropdown-link">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink1"
                                       data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-globe"></i>
                                        English</a>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{ asset('logo.png') }}" style="height: 66px"
                                                      alt="Dana Holdings"></a>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between align-items-center">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="home6-onepage.html">Building Company Onepage</a></li>
                                                    <li><a href="home7-onepage.html">Build Craft Onepage</a></li>
                                                    <li><a href="home8-onepage.html">Industry Manufacture Onepage</a>
                                                    </li>
                                                    <li><a href="home9-onepage.html">Solar Energy Onepage</a></li>
                                                    <li><a href="home10-onepage.html">Infinite Construction Onepage</a>
                                                    </li>
                                                    <li><a href="home11-onepage.html">Company Solution Onepage</a></li>
                                                    <li><a href="home12-onepage.html">Building Company Onepage</a></li>
                                                    <li><a href="home13-onepage.html">Building Company Onepage</a></li>
                        ...
                        <div class="col-auto d-none d-lg-block">
                            <div class="header-button">
                                ...
                                <a href="contact.html" class="th-btn style8 ml-25">GET A QUOTE <i
                    ...
                    <div class="col-xxl-8 col-lg-7 col-md-8">
                        <div class="hero-style1">
                            ...
                            <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s">
                                <a href="contact.html" class="th-btn style3">Discover More <i
                                        class="fas fa-arrow-right ms-2"></i></a>
                                <a href="service.html" class="th-btn style2">Our Services <i
                                        class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-lg-5 col-md-4">
                        <div class="hero-video-wrap text-center">
                ...
                <div class="row align-items-center">
                    <div class="col-xxl-8 col-lg-7 col-md-8">
                        <div class="hero-style1">
                            <span class="hero-subtitle" data-ani="slideinleft" data-ani-delay="0.1s"><img
                                    src="assets/img/icon/subtitle-img1-1.svg" alt="img"> We Build, You Thrive</span>
                            <h1 class="hero-title text-white" data-ani="slideinleft" data-ani-delay="0.4s">Building the
                                Future, Bridging <span class="text-theme fw-normal">Innovations</span></h1>
                            <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.6s">Construction companies
                                offer a wide range of services, such as pre-construction planning, project management,
                                design and architectural services.</p>
                            <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s">
                ...
                <div class="row align-items-center">
                    <div class="col-xxl-8 col-lg-7 col-md-8">
                        <div class="hero-style1">
                            <span class="hero-subtitle" data-ani="slideinleft" data-ani-delay="0.1s"><img
                                    src="assets/img/icon/subtitle-img1-1.svg" alt="img"> We Build, You Thrive</span>
                            <h1 class="hero-title text-white" data-ani="slideinleft" data-ani-delay="0.4s">Raising
                                Structures, Elevating <span class="text-theme fw-normal">Standards</span></h1>
                            <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.6s">Construction companies
                                offer a wide range of services, such as pre-construction planning, project management,
                                design and architectural services.</p>
                            <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-auto">
                    <div class="title-area mb-md-0">
                        <span class="sub-title"><img src="assets/img/icon/subtitle-img1-1.svg"
                                                     alt="img"> OUR SERVICES</span>
                        <h2 class="sec-title">The Best Service For You</h2>
                    </div>
                </div>
                <div class="col-auto">
                    <a class="th-btn" href="service.html">View All Services <i class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-3">
                <div class="service-tab-menu nav">
                    <button class="tab-btn active" data-bs-toggle="tab" data-bs-target="#service-tab-1">Building
                        Constructions
                    </button>
                    <button class="tab-btn" data-bs-toggle="tab" data-bs-target="#service-tab-2">Roof Constructions
                    </button>
                    <button class="tab-btn" data-bs-toggle="tab" data-bs-target="#service-tab-3">Building Repairs
                    </button>
                    <button class="tab-btn" data-bs-toggle="tab" data-bs-target="#service-tab-4">Real Estate
                        Constructions
                    </button>
                    <button class="tab-btn" data-bs-toggle="tab" data-bs-target="#service-tab-5">Company Construction
                    </button>
                    <button class="tab-btn" data-bs-toggle="tab" data-bs-target="#service-tab-6">Interior Construction
                    </button>
                </div>
            </div>
            <div class="col-lg-9">
                <div class="service-slider1 tab-content">
                    ...
                    <div class="tab-pane fade" id="service-tab-5" role="tabpanel">
                        <div class="row th-carousel" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="2">
                            <div class="col-md-6 col-xl-4">
                                <div class="service-card">
                                    <div class="service-card-content"
                    ...
                    <div class="tab-pane" id="service-tab-6">
                        <div class="row th-carousel" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="2">
                            <div class="col-md-6 col-xl-4">
                                <div class="service-card">
                                    <div class="service-card-content"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6">
                <div class="title-area mb-30">
                    <span class="sub-title"><img src="assets/img/icon/subtitle-img1-1.svg"
                                                 alt="img"> About Us Company</span>
                    <h2 class="sec-title">We Are Always Think On Your Dream</h2>
                </div>
                <p class="mt-n2 mb-35">Many modern construction companies focus on sustainable building practices,
                    incorporating eco-friendly material energy-efficient systems and environmental conscious designs to
                    reduce the environmental impact of their projects.</p>
                <div class="about-grid2">
                    <div class="icon">
                        <img src="assets/img/icon/about-grid-icon1.svg" alt="img">
                    </div>
                    <div class="about-grid-details">
                        <h3 class="about-grid_title h6">Worldwide Services</h3>
                ...
                <div class="about-grid2">
                    ...
                    <div class="about-grid-details">
                        <h3 class="about-grid_title h6">Best Company Award Winner</h3>
        ...
        <div class="row justify-content-between gy-5">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="counter-grid">
                    ...
                    <div class="details">
                        <h2 class="counter-grid_number"><span class="counter-number">3</span>k+</h2>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="counter-grid">
                    <div class="counter-grid_icon">
                        <img src="assets/img/icon/counter-icon1-3.svg" alt="img">
                    </div>
                    <div class="details">
                        <h2 class="counter-grid_number"><span class="counter-number">1.9</span>k+</h2>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="counter-grid">
                    <div class="counter-grid_icon">
                        <img src="assets/img/icon/counter-icon1-4.svg" alt="img">
                    </div>
                    <div class="details">
                        <h2 class="counter-grid_number"><span class="counter-number">1</span>k+</h2>
                        <p class="counter-grid_text">Award Wins</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="overflow-hidden space" data-bg-src="assets/img/bg/project_bg_1.png">
    <div class="container">
        <div class="mb-35">
            <div class="row justify-content-between align-items-center">
                <div class="col-auto">
                    <div class="title-area mb-lg-0">
                        <span class="sub-title"><img src="assets/img/icon/subtitle-img1-1.svg"
                                                     alt="img"> Our Projects</span>
                        <h2 class="sec-title">Building Your Dream Projects</h2>
                    </div>
                </div>
                <div class="col-auto">
                    <a class="th-btn" href="project.html">View All Projects <i class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
        </div>
        <div class="row th-carousel project-slider1" data-slide-show="3" data-xl-slide-show="3" data-ml-slide-show="3"
             data-lg-slide-show="2" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1"
             data-center-mode="true" data-xl-center-mode="true" data-ml-center-mode="true" data-dots="false"
             data-adaptive-height="true">
            <div class="col-lg-4 col-xl-3">
                <div class="project-card">
                    <div class="project-card-img">
                        <img src="assets/img/project/project-1-1.png" alt="project image">
                    </div>
                    <div class="project-card-icon">
                        <img src="assets/img/icon/project-icon1-1.svg" alt="">
                    </div>
                    <div class="project-card-details" data-bg-src="assets/img/project/project-card-bg.png">
                        <h4 class="box-title"><a href="project-details.html">General Construction</a></h4>
                        <p class="project-card-content">Good communication is crucial in the construction industry. A
                            construction company maintains open</p>
                        <a href="project-details.html" class="th-btn style9">Read More <i
                                class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-xl-3">
                <div class="project-card">
                    <div class="project-card-img">
                        <img src="assets/img/project/project-1-2.png" alt="project image">
                    </div>
                    <div class="project-card-icon">
                        <img src="assets/img/icon/project-icon1-2.svg" alt="">
                    </div>
                    <div class="project-card-details" data-bg-src="assets/img/project/project-card-bg.png">
                        <h4 class="box-title"><a href="project-details.html">Architecture & Building</a></h4>
                        <p class="project-card-content">Some companies may specialize in specific types of projects,
                            while others may handle diverse projects.</p>
                        <a href="project-details.html" class="th-btn style9">Read More <i
                                class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-xl-3">
                <div class="project-card">
                    <div class="project-card-img">
                        <img src="assets/img/project/project-1-3.png" alt="project image">
                    </div>
                    <div class="project-card-icon">
                        <img src="assets/img/icon/project-icon1-3.svg" alt="">
                    </div>
                    <div class="project-card-details" data-bg-src="assets/img/project/project-card-bg.png">
                        <h4 class="box-title"><a href="project-details.html">Interior Design</a></h4>
                        <p class="project-card-content">Interior design is the art and science of enhancing the interior
                            spaces of a building to achieve a healthier</p>
                        <a href="project-details.html" class="th-btn style9">Read More <i
                                class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
...
<div class="why-area-1 space overflow-hidden">
    <div class="container">
        <div class="row flex-xl-row flex-column-reverse">
            <div class="col-xl-10">
                <div class="wcu-wrap1 bg-theme" data-bg-src="assets/img/bg/why-bg-1.png">
                    <div class="title-area mb-25">
                        <span class="sub-title text-white"><img src="assets/img/icon/subtitle-img1-1.svg" alt="img"> WHY CHOOSE US</span>
                        <h2 class="sec-title text-white">High Quality Construction Projects & Innovate Design!</h2>
                    </div>
                    <div class="row gy-4">
                        <div class="col-lg-6">
                            <div class="wcu-box">
                                ...
                                <div class="wcu-box_details">
                                    <h3 class="box-title">Quality Control System</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="wcu-box">
                                ...
                                <div class="wcu-box_details">
                                    <h3 class="box-title">Highly Professional Staff</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="wcu-box">
                                ...
                                <div class="wcu-box_details">
                                    <h3 class="box-title">Accurate Testing Processes</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="btn-group mt-40">
                        <a class="th-btn style6" href="about.html">Learn More <i
                                class="fas fa-arrow-right ms-1"></i></a>
                        <a class="th-btn style2" href="about.html">Build Your Dream Now <i
                                class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                    <div class="video-wrap" data-bg-src="assets/img/bg/why-bg-1.png">
                        <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn style4 popup-video"
                           tabindex="0"><i class="fa-sharp fa-solid fa-play"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-2">
        ...
        <div class="row g-0 align-items-center">
            <div class="col-xl-5">
                <div class="cta-wrap title-area mb-0 bg-theme">
                    <span class="sub-title text-white"><img src="assets/img/icon/subtitle-img1-1.svg" alt="img"> Call To Action</span>
                    <h2 class="sec-title text-white">Have An Upcoming Projects? Let’s Talk to Now!</h2>
                    <p class="sec-text text-white">An increasing number of interior designers focus on sustainable and
                        eco-friendly design practices.</p>
                    ...
                    <a href="about.html" class="th-btn style6">More About us<i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="col-xl-7">
                    ...
                    <form action="mail.php" method="POST" class="contact-form ajax-contact">
                        <div class="row">
                            ...
                            <div class="form-btn col-12">
                                <button class="th-btn w-100">Send Message<i class="fas fa-long-arrow-right ms-2"></i>
                                </button>
                            </div>
                        </div>
...
<section class="space overflow-hidden">
    <div class="container">
        <div class="mb-45">
            <div class="row justify-content-between align-items-center">
                <div class="col-auto">
                    <div class="title-area mb-md-0">
                        <span class="sub-title"><img src="assets/img/icon/subtitle-img1-1.svg" alt="img"> Photo Gallery</span>
    ...
    <div class="container-fluid">
        <div class="row th-carousel project-slider2" data-slide-show="4" data-ml-slide-show="3" data-lg-slide-show="3"
...
<section class="testi-area-1 overflow-hidden space" data-bg-src="assets/img/bg/testi_bg_1.png" data-overlay="smoke"
         data-opacity="9">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="th-carousel testi-slider1 slider-shadow row" data-slide-show="2" data-ml-slide-show="2"
                     data-lg-slide-show="1" data-md-slide-show="1" data-arrows="true">
                    <div class="col-lg-6">
                        <div class="testi-card">
                            ...
                            <div class="testi-card_content">
                                <p class="testi-card_text">They select color, texture, pattern, & materials that create
                                    a cohesive and visual pleasing look while reflecting the clients personality and
                                    taste. Interior designers.</p>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="title-area mb-lg-0 text-lg-start text-center">
                        <h2 class="sec-title text-white">Our Trusted Brands</h2>
                        <p class="text-light">Good communication is crucial in the construction industry. A construction
                            company maintains.</p>
                        <div class="icon-box">
                            <button data-slick-prev=".client-slider1" class="slick-arrow default"><i
                                    class="far fa-arrow-left"></i></button>
                            <button data-slick-next=".client-slider1" class="slick-arrow default"><i
...
<footer class="footer-wrapper footer-layout1" data-bg-src="assets/img/bg/footer1-bg.png" data-overlay="title"
        data-opacity="9">
                ...
                <div class="col-md-6 col-xxl-3 col-xl-3">
                    <div class="widget footer-widget">
                        <div class="th-widget-about">
                            ...
                            <p class="about-text mb-4">Quickly supply alternative strategic theme areas vis-à-vis B2C
                                mindshare. Objectively repurpose stand-alone.</p>
                            <div class="th-widget-contact">
                        ...
                        <div class="recent-post-wrap">
                            <div class="recent-post">
                                ...
                                <div class="media-body">
                                    ...
                                    <h4 class="post-title"><a class="text-inherit" href="blog-details.html">Regular
                                            inspections and quality check</a></h4>
                                </div>
                            </div>
                            <div class="recent-post">
                                <div class="media-img">
    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <p class="copyright-text">Copyright © 2023 <a href="index.html">Konta</a> All Rights Reserved.</p>
                </div>
